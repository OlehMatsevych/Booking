        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoomsAmount = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApartmentRequests_Admins_AdminId",
                        column: x => x.AdminId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Apartments_Admins_AdminId",
                        column: x => x.AdminId,
                        principalTable: "Admins",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApartmentProviders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApartmentProviders_Apartments_ApartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApartmentId = table.Column<Guid>(nullable: true),
                    RoomDetailsId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Rooms_RoomsDetails_RoomDetailsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApartmentProviders_ApartmentId",
                table: "ApartmentProviders",
                column: "ApartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ApartmentRequests_AdminId",
                table: "ApartmentRequests",
                column: "AdminId");

            migrationBuilder.CreateIndex(
                name: "IX_ApartmentRequests_ApartmentProviderId",
                table: "ApartmentRequests",
                column: "ApartmentProviderId");

            migrationBuilder.CreateIndex(
                name: "IX_Apartments_AdminId",
                table: "Apartments",
                column: "AdminId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Guests_AdminId",
                table: "Guests",
                column: "AdminId");

            migrationBuilder.CreateIndex(
                name: "IX_Guests_ApartmentProviderId",
                table: "Guests",
                column: "ApartmentProviderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rooms_RoomDetailsId",
                table: "Rooms",
                column: "RoomDetailsId");

            migrationBuilder.AddForeignKey(
                name: "FK_ApartmentRequests_ApartmentProviders_ApartmentProviderId",
                table: "ApartmentRequests",
                column: "ApartmentProviderId",
                principalTable: "ApartmentProviders",
                principalColumn: "Id",
